...
export const metadata = {
  ...
  description:
    "Unlock competitive rates and expert guidance for home loans and reverse mortgages in Utah with Kenny Farshchian. Request a free consultation today!",
  alternates: {
    canonical: "https://www.mortgagekenny.com/Loans",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    url: "https://www.mortgagekenny.com/Loans",
    title: "Home Loans & Reverse Mortgages in Utah - Kenny Farshchian",
    type: "website",
    description:
      "Unlock competitive rates and expert guidance for home loans and reverse mortgages in Utah with Kenny Farshchian. Request a free consultation today!",
    images: [
      "https://www.mortgagekenny.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fsmalllogokenny.8cfc83f9.png&w=1080&q=75",
    ],
    twitter: {
  ...
  return (
    <>
      ...
      <Container>
        ...
        <h3 id="Reverse-Mortgage-Florida-Container-h3">
          Not sure what type of loan you need, or what you qualify for? We offer
          more than a dozen types of loans and expert guidance to help you find
          the right loan for the home you want, with the best payment options.
        </h3>
        <Button
          id="Reverse-Mortgage-Florida-Container-button"
          target="_blank"
        ...
        <Grid
          id="Reverse-Mortgage-Florida-Container-grid"
          container
          spacing={3}
        >
          <Grid item xs={4}>
            <div>
              <h4 id="Reverse-Mortgage-Florida-Container-h4">
                Reverse Mortgage
              </h4>
              <p>
                Enables the borrower to access the unencumbered value of the
                property.
              </p>
            </div>
          </Grid>
          <Grid item xs={4}>
            <div>
              ...
              <p>
                Designed for those who wish to start out with a lower
          ...
          <Grid item xs={4}>
            <div>
              ...
              <p>
                Loans up to $31k above purchase price toward remodeling or home
                repairs.
              </p>
            </div>
          </Grid>
          <Grid item xs={4}>
            <div>
              ...
              <p>
                Special loan programs for either built or unbuilt manufactured
                homes.
              </p>
            </div>
          </Grid>
          ...
          <Grid item xs={4}>
            <div>
              ...
              <p>
                Finances home purchase and installation of energy-saving
                upgrades.
              </p>
            </div>
          </Grid>
          <Grid item xs={4}>
            <div>
              ...
              <p>
                Finances land, construction, and permanent mortgage into one
                loan.
              </p>
            </div>
          </Grid>
          ...
          <Grid item xs={4}>
            <div>
              ...
              <p>
                Special financing for buyers with past credit issues like
          ...
          <Grid item xs={4}>
            <div>
              ...
              <p>
                Finances home purchases up to $2.5 million with options for low
          ...
          <Grid item xs={4}>
            <div>
              ...
              <p>
                Government-backed loan great for first-time homebuyers or those
          ...
          <Grid item xs={4}>
            <div>
              ...
              <p>
                Offers zero-down financing to those whose homes were damaged or
          ...
          <Grid item xs={4}>
            <div>
              ...
              <p>
                Options to finance investment property, or to use rental income
                or asset depreciation as qualifying income.
              </p>
            </div>
          </Grid>
          <Grid item xs={4}>
            <div>
              ...
              <p>
                Loans tailored to those who have served or are currently serving
                in the military.
              </p>
            </div>
          </Grid>
